                  ...
                  <View style={styles.clientHeader}>
                    <View style={styles.clientIconContainer}>
                      ...
                      >
                        <Icon
                          size={20}
                          color={client.type === 'physical' ? Colors.info : Colors.accent}
                        />
                      </View>
                    ...
                    <View
                      style={[
                        styles.statusDot,
                        { backgroundColor: client.active ? Colors.success : Colors.error },
                      ]}
                    />
                  </View>
              ...
              <ScrollView style={styles.modalBody} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.formGroup}>
                  ...
                  <View style={styles.typeSelector}>
                    ...
                    >
                      <User
                        size={18}
                        color={formData.type === 'physical' ? Colors.white : Colors.textSecondary}
                      />
                      <Text
                        style={[
                    ...
                    <TouchableOpacity
                      style={[
                        styles.typeOption,
                        formData.type === 'legal' && styles.typeOptionActive,
                      ]}
                      onPress={() => setFormData({ ...formData, type: 'legal' })}
                    >
                      <Building2
                        size={18}
                        color={formData.type === 'legal' ? Colors.white : Colors.textSecondary}
                      />
                      <Text
                        style={[
                          styles.typeOptionText,
                ...
                <View style={styles.formGroup}>
                  <Text style={styles.formLabel}>
                    {formData.type === 'physical' ? 'Nome Completo' : 'Razão Social'} *
                  </Text>
                  <TextInput
                    style={styles.formInput}
                    placeholder={
                      formData.type === 'physical' ? 'Nome do cliente' : 'Razão social da empresa'
                    }
                ...
                <View style={styles.formGroup}>
                  <Text style={styles.formLabel}>
                    {formData.type === 'physical' ? 'CPF' : 'CNPJ'} *
                  </Text>
                  <TextInput
                    style={styles.formInput}
                    placeholder={
                      formData.type === 'physical' ? '000.000.000-00' : '00.000.000/0000-00'
                    }
                    placeholderTextColor={Colors.textTertiary}
