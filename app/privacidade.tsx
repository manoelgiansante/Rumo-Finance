      ...
      >
        ...
        <Section title="3. Dados Coletados">
          ...
          <Text style={styles.text}>
            ...
            do aplicativo (funcionalidades acessadas, tempo de uso){'\n'}• Endereço IP e informações
        ...
        <Section title="4. Base Legal e Finalidades do Tratamento">
          <Text style={styles.text}>
            ...
            <Text style={styles.bold}>
              c) Cumprimento de Obrigação Legal (Art. 7º, II da LGPD):
            </Text>
            {'\n'}
        ...
        <Section title="5. Compartilhamento de Dados">
          <Text style={styles.text}>
            ...
            <Text style={styles.bold}>Prestadores de serviço:</Text> Empresas que nos auxiliam na
            operação do aplicativo (hospedagem em nuvem, análise de dados, suporte técnico){'\n\n'}•{' '}
            <Text style={styles.bold}>Autoridades governamentais:</Text> Quando exigido por lei ou
            ordem judicial{'\n\n'}• <Text style={styles.bold}>Parceiros comerciais:</Text> Mediante
            seu consentimento expresso{'\n\n'}
            Garantimos que todos os terceiros que acessam seus dados estão obrigados a protegê-los
            de acordo com esta Política e a LGPD.
          </Text>
        </Section>

        <Section title="6. Armazenamento e Segurança">
          <Text style={styles.text}>
            Seus dados são armazenados em servidores seguros com criptografia e protegidos por
            ...
            {'\n\n'}
            Os dados são mantidos pelo tempo necessário para as finalidades informadas ou conforme
            exigido por lei.
          </Text>
        </Section>
        ...
        <Section title="7. Seus Direitos (LGPD)">
          <Text style={styles.text}>
            ...
            acessá-los{'\n'}• <Text style={styles.bold}>Correção:</Text> Solicitar correção de dados
            incompletos ou incorretos{'\n'}•{' '}
            <Text style={styles.bold}>Anonimização ou exclusão:</Text> Solicitar eliminação de dados
            desnecessários{'\n'}• <Text style={styles.bold}>Portabilidade:</Text> Receber seus dados
            em formato estruturado{'\n'}•{' '}
            <Text style={styles.bold}>Revogação de consentimento:</Text> Retirar consentimento a
            qualquer momento{'\n'}•{' '}
            <Text style={styles.bold}>Informação sobre compartilhamento:</Text> Saber com quem
        ...
        <Section title="9. Transferência Internacional de Dados">
          <Text style={styles.text}>
            ...
            LGPD e mediante garantias adequadas de proteção.
          </Text>
        </Section>
        ...
        <Section title="10. Alterações nesta Política">
          <Text style={styles.text}>
            ...
            comunicadas por e-mail ou notificação no aplicativo.
          </Text>
        </Section>
