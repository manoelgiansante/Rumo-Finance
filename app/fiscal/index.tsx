...
const mockNFes: NFe[] = [
  {
    ...
    items: [],
    transport: { freightType: 'emitente' },
    payment: { method: 'boleto', type: 'a_vista' },
    funrural: { enabled: true, base: 100000, aliquot: 2.3, value: 2300 },
    productsValue: 100000,
    freightValue: 0,
    insuranceValue: 0,
    otherExpenses: 0,
    discount: 0,
    ...
    icmsValue: 0,
    status: 'authorized',
    accessKey: '35250112345678000190550010000124501000124501',
    protocol: '135250000124501',
    createdBy: 'user-1',
    createdAt: new Date('2025-01-15'),
    authorizedAt: new Date('2025-01-15'),
  },
  {
    id: 'nfe-2',
    number: 1246,
    ...
    items: [],
    transport: { freightType: 'destinatario' },
    payment: { method: 'boleto', type: 'a_prazo', installments: 3 },
    funrural: { enabled: false },
    productsValue: 85000,
    freightValue: 2500,
    insuranceValue: 0,
    otherExpenses: 0,
...
const mockMDFes: MDFe[] = [
  {
    ...
    originCity: 'Araraquara',
    originState: 'SP',
    destinationCity: 'São Paulo',
    destinationState: 'SP',
    issueDate: new Date('2025-01-15'),
    accessKey: '35250112345678000190580010000004501000004501',
    protocol: '135250000004501',
    createdBy: 'user-1',
    createdAt: new Date('2025-01-15'),
  },
];
