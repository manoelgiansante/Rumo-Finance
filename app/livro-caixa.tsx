...
const mockEntries: LivroCaixaEntry[] = [
  { 
    ...
    document: 'NF-e 1245', 
    description: 'Venda de Gado Gordo - Lote 15', 
    type: 'receita', 
    ...
    status: 'validated',
    invoiceNumber: '1245',
    nfeKey: '35250112345678000190550010000124501000124501',
  ...
  { 
    ...
    document: 'NF-e 8547', 
    description: 'Compra de Ração Animal', 
    type: 'despesa', 
    category: 'Insumos', 
    value: 25000, 
    operation: 'Confinamento',
    status: 'sent_accountant',
    invoiceNumber: '8547',
  ...
  { 
    ...
    document: 'Recibo 001', 
    description: 'Pagamento de Funcionário Temporário', 
    type: 'despesa', 
  ...
  { 
    ...
    document: 'NF-e 1244', 
    description: 'Venda de Cana-de-açúcar', 
    type: 'receita', 
    category: 'Venda Produção', 
    value: 95000, 
    operation: 'Cana',
    status: 'processed',
    invoiceNumber: '1244',
    nfeKey: '35250112345678000190550010000124401000124401',
    validatedAt: new Date('2025-01-12'),
    sentAt: new Date('2025-01-13'),
  },
  { 
    id: '5', 
  ...
  { 
    ...
    document: 'NF-e 1243', 
    description: 'Venda de Composto Orgânico', 
    type: 'receita', 
    category: 'Venda Produção', 
    value: 12000, 
    operation: 'Compostagem',
    status: 'validated',
    invoiceNumber: '1243',
