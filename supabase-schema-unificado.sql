-- =====================================================
-- SCHEMA UNIFICADO AGROFINANCE V2
-- Combina: Gestão Rural + Custo Operacional Rural
...
-- =====================================================
-- 3. SECTORS (Setores - do Custo Operacional)
-- =====================================================
...
CREATE TABLE IF NOT EXISTS user_subscriptions (
  ...
  -- Se true, Custo Operacional é grátis por ter Gestão Rural intermediário+
...
-- Função para dar bônus de Custo Operacional quando assina Gestão Rural intermediário+
